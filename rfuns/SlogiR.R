...
sfaov <- function(formula,   data, conf.level= .95){
  # Description: To be added.
  
  stop("Wrong formula, should be of the form  y ~  x   ... or your data is not in tidy or data matrix format... of if you are trying to include more covariates, then use aov() or lm()")
